...
// clang-format off
template<> const std::string message< long >::value = "taopq::internal::strtol() failed for input: ";
template<> const std::string message< unsigned long >::value = "taopq::internal::strtoul() failed for input: ";
template<> const std::string message< long long >::value = "taopq::internal::strtoll() failed for input: ";
template<> const std::string message< unsigned long long >::value = "taopq::internal::strtoull() failed for input: ";

template<> const std::string message< float >::value = "taopq::internal::strtof() failed for input: ";
template<> const std::string message< double >::value = "taopq::internal::strtod() failed for input: ";
template<> const std::string message< long double >::value = "taopq::internal::strtold() failed for input: ";
// clang-format on
...
[[nodiscard]] T str_to_integral( const char* input, const int base )
{
    ...
    case ERANGE:
        ...
        throw std::runtime_error( taopq::internal::printf( "code should be unreachable, errno: ERANGE, input: \"%s\"", input ) );  // LCOV_EXCL_LINE
    }
    throw std::runtime_error( taopq::internal::printf( "code should be unreachable, errno: %d, input: \"%s\"", errno, input ) );  // LCOV_EXCL_LINE
}

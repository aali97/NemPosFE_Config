...
bool result_traits< bool >::from( const char* value )
{
    ...
    throw std::runtime_error( "invalid value in taopq::result_traits<bool> for input: " + std::string( value ) );
}

char result_traits< char >::from( const char* value )
{
    if( value[ 0 ] == '\0' || value[ 1 ] != '\0' ) {
        throw std::runtime_error( "invalid value in taopq::result_traits<char> for input: " + std::string( value ) );
    }
    return value[ 0 ];
}
...
signed char result_traits< signed char >::from( const char* value )
{
    ...
    if( v < std::numeric_limits< signed char >::min() ) {
        throw std::underflow_error( "underflow error in taopq::result_traits<signed char> for input: " + std::string( value ) );
    }
    if( v > std::numeric_limits< signed char >::max() ) {
        throw std::overflow_error( "overflow error in taopq::result_traits<signed char> for input: " + std::string( value ) );
    }
...
unsigned char result_traits< unsigned char >::from( const char* value )
{
    ...
    if( v > std::numeric_limits< unsigned char >::max() ) {
        throw std::overflow_error( "overflow error in taopq::result_traits<unsigned char> for input: " + std::string( value ) );
    }
...
short result_traits< short >::from( const char* value )
{
    ...
    if( v < std::numeric_limits< short >::min() ) {
        throw std::underflow_error( "underflow error in taopq::result_traits<short> for input: " + std::string( value ) );
    }
    if( v > std::numeric_limits< short >::max() ) {
        throw std::overflow_error( "overflow error in taopq::result_traits<short> for input: " + std::string( value ) );
    }
...
unsigned short result_traits< unsigned short >::from( const char* value )
{
    ...
    if( v > std::numeric_limits< unsigned short >::max() ) {
        throw std::overflow_error( "overflow error in taopq::result_traits<unsigned short> for input: " + std::string( value ) );
    }
...
int result_traits< int >::from( const char* value )
{
    ...
    if( v < std::numeric_limits< int >::min() ) {
        throw std::underflow_error( "underflow error in taopq::result_traits<int> for input: " + std::string( value ) );
    }
    if( v > std::numeric_limits< int >::max() ) {
        throw std::overflow_error( "overflow error in taopq::result_traits<int> for input: " + std::string( value ) );
    }
...
unsigned result_traits< unsigned >::from( const char* value )
{
    ...
    if( v > std::numeric_limits< unsigned >::max() ) {
        throw std::overflow_error( "overflow error in taopq::result_traits<unsigned> for input: " + std::string( value ) );
    }
